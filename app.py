...
# ---------------------------------------------------------------------------- #
st.set_page_config(
    page_title="CareerForge - Career War Room",
    page_icon="🎯",
    layout="wide",
...
if not st.session_state.analyzed:
    ...
    with mid:
        st.markdown(
            ...
            " color:#2C1A0E; margin-bottom:0.35rem; line-height:1.15;'>CareerForge</div>"
...
st.markdown(
    ...
    "CareerForge &middot; Built for placement season &middot; Made with <3 by Vivek"
    "</div>",
    unsafe_allow_html=True,
)
